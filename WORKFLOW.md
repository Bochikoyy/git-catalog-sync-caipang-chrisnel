...
This exercise simulated three contributors independently modifying the same `feature/late-fee-policy` branch. Three separate local clones were used to demonstrate rejected pushes, merge conflicts, a stale third contributor, and conflict resolution through both merging and rebasing.
...
![Task 1 - Grace period committed and pushed](screenshots/task1.png)
...
![Task 2 - Rejected push from Clone B](screenshots/task2.png)
...
![Task 3 - Merge conflict resolved and pushed](screenshots/task3.png)
...
![Task 4 - Rejected push from Clone C](screenshots/task4.png)
...
![Task 5 - Three contributors reconciled](screenshots/task5.png)
...
![Task 6 - Rejected push and rebase reconciliation](screenshots/task6.png)

---

## Task 7 - Merge into Main and Tag the Final Version

The completed `feature/late-fee-policy` branch was merged into `main`.

The final implementation contained the grace period, rounding behavior, maximum fee, and minimum fee. The final tests passed, `main` was pushed to GitHub, and the final commit was tagged as `v1.0-synced`.

![Task 7 - Merged into main and tagged](screenshots/task7.png)
